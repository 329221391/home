...
class XingeApp
{
    ...
    //my android
    public static function PushTokenAndroidMsg($accessId, $secretKey, $title, $content, $token)
    {
    	(new BaseAnalyze())->writeToAnal('PushTokenAndroidMsg');
        $push = new XingeApp($accessId, $secretKey);
        $mess = new Message();
        $mess->setTitle($title);
        $mess->setContent($content);
    ...
    public static function PushTokenAndroidMsg2($accessId, $secretKey, $title, $content, $token)
    {
        $push = new XingeApp($accessId, $secretKey);
        $mess = new Message();
        $mess->setTitle($title);
    ...
    public static function PushAllAndroidForMsg($accessId, $secretKey, $title, $content)
    {
        $push = new XingeApp($accessId, $secretKey);
        $mess = new Message();
        $mess->setTitle($title);
