...
namespace app\modules\Admin\ZhaoPin\controllers;
...
class ZhaopinController extends BaseController{
    ...
    public function actionIndex(){
        ...
        foreach ($zhaopin_list as &$item) {
            $item['url'] = Url::to('index.php?r=zhaopin/view&id='.$item['id'],true);
            $item['create_time'] = date('Y-m-d H:i',$item['create_time']);
            if(empty($item['img_url'])){
                $item['img_url'] = Url::to('/images/default_zhaopin.png',true);
            }
        }
