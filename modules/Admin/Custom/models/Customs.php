   ...
   */
    ...
    */
    ...
    public function addPoint($e)
    {
        ...
        //处理 game_points
        $db = Yii::$app->db;
        $db->createCommand('update customs set `game_points` = `game_points` + '.$e->data['num'].' where `id` = '.self::get_CustomId($e->data['custom_id']))->execute();
    ...
    public function changeclass($class_id,$custom_id){
        $custom = self::findOne($custom_id);
        $custom->setClassId($class_id);
        $custom->save();
    }
}
