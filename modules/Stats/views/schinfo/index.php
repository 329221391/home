    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            if ($pathinfo['school_id']) { ?>
                <a href="index.php?r=Stats/info/man&school_id=<?= $pathinfo['school_id'] ?>" target="_blank"> <?= $pathinfo['name'] ?></a>
            <?php } else {
                echo $pathinfo['name'];
            } ?>
        </div>
    ...
    <table class="table table-striped table-hover">
        ...
        <tr>
            ...
            <td>
                <?php
                if (!$pathinfo['school_id']) { ?>
                    <a href="index.php?r=Stats/usedsch/index&type=<?= CatDef::$mod['rf'] ?>&s=<?= $pathinfo['s'] ?>&e=<?= $pathinfo['e'] ?>"> <?= $status['redfl']['num'] ?></a>
                <?php } else {
                    echo $status['redfl']['num'];
                } ?>
            </td>
        </tr>
    </table>
