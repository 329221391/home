                ...
                <form class="form-inline" action="" method="post" style="margin-bottom:15px;">
                    ...
                    <div style="margin-left: 20px;">
                        <div class="form-group">
                            <a  href="index.php?r=manage/zhaosheng/create" class="btn btn-info">添加</a>
                        </div>
                    </div>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a style="color:#fff;" target="_blank" class="btn btn-xs btn-info"
                                           href="index.php?r=zhaosheng/view&id=52">预览</a>
                                        <a style="color:#fff;" class="btn btn-xs btn-info"
                                           href="index.php?r=manage/zhaosheng/creat-by-template&id=52">应用</a>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="adv-table editable-table">
                            <table class="table table-striped table-hover table-bordered" id="editable-sample"
                                ...
                                <tr style="background:#f0ad4e;color:#FFFFFF;">
                                    <th class="text-center" style="line-height:30px;width:40%">招生标题</th>
                                    <th class="text-center" style="line-height:30px;width:20%">招生电话</th>
                                    <th class="text-center" style="line-height:30px;width:20%">创建时间</th>
                                    <th class="text-center" style="line-height:30px;width:20%">操作</th>
                                </tr>
                                <?php foreach ($zhaosheng_list as $kk => $vv) { ?>
                                    <tr class="text-center">
                                        <td><?= $vv['title'] ?></td>
                                        <td><?= $vv['post_phone'] ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a style="color:#fff;" class="btn btn-xs btn-info"
                                               href="index.php?r=manage/zhaosheng/edit&id=<?= $vv['id'] ?>">编辑</a>
                                            <a style="color:#fff;" target="_blank" class="btn btn-xs btn-info"
                                               href="index.php?r=zhaosheng/view&id=<?= $vv['id'] ?>">预览</a>
                                            <a style="color:#fff;" class="btn btn-xs btn-info"
                                               href="index.php?r=manage/zhaosheng/post&id=<?= $vv['id'] ?>">详情</a>
                                            <a style="color:#fff;" class="btn btn-xs btn-danger"
                                               href="javascript:if(confirm('确定删除')){window.location.href='index.php?r=manage/zhaosheng/delete&id=<?= $vv['id'] ?>';}">删除</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </table>
