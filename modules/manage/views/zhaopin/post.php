                ...
                <form class="form-inline" action="index.php" method="get" style="margin-bottom:15px;margin-left:20px;">
                    <div class="pull-right">
                        <div class="form-group">
                            <input type="hidden" name="r" value="manage/zhaopin/post" />
                        ...
                        <div class="adv-table editable-table">
                            <table class="table table-striped table-hover table-bordered" id="editable-sample"
                                ...
                                <tr style="background:#f0ad4e;color:#FFFFFF;">
                                    <th class="text-center" style="line-height:30px;width:25%">姓名</th>
                                    <th class="text-center" style="line-height:30px;width:25%">电话</th>
                                    <th class="text-center" style="line-height:30px;width:25%">年龄</th>
                                    <th class="text-center" style="line-height:30px;width:25%">报名时间</th>

                                </tr>
                                <?php foreach ($post_list as $kk => $vv) { ?>
                                    <tr class="text-center">
                                        <td><?= $vv['person_name'] ?></td>
                                        <td><?= $vv['mobile'] ?></td>
                                        <td><?= $vv['age'] ?></td>
